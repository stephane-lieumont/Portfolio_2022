...
const Contact: React.FunctionComponent<PageProps> = ({
  ...
  return (
    <div
      ref={currentPage}
      className={`${isModal ? " contact-modal" : "page"} contact`}
    ...
    >
      ...
      >
        ...
        <section className="contact__content">
          <p>Un projet, une question où juste un Hello World ?</p>
          <FormContact />
        </section>
        ...
        <div className="contact__bg">
          <img
            ...
            src={require("../../assets/profile/profil-stephane-lieumont-contact.jpg")}
