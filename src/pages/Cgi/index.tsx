...
const Cgi: React.FunctionComponent<PageProps> = ({title = 'titre de la page'}) => {
  ...
  useEffect(() => {
    ...
    const revealSectionSpecialities = scrollPosition >= sectionSpecialities.current!.offsetTop - windowSize.height + 100
    const revealSectionPortfolio = scrollPosition >= sectionPortfolio.current!.offsetTop - windowSize.height + offsetApear
