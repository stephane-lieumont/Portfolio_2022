  ...
  return (
    <div className='page error' style={{ paddingTop: headerheigth + 30 + 'px' }} data-testid='page-error'>
      ...
      <section className='error__container page__content'>
        ...
        <img width={500} className={!imgLoaded ? 'loading' : '' } onLoad={() => setImgLoaded(true)} src={require('~/assets/gif/travolta-comfused.gif')} alt="travolta confusion page introuvable" />
      </section>
      <Footer />   
    </div>
  );
