  ...
  return (
    <div
      className={`background-svg${
        darken ? " background-svg--darken" : ligthen ? " background-svg--ligthen" : ""
      }`}
      ...
      <Fragment>
        {triangle ? (
          ...
          >
            <TriangleSVG
              className={`${
                darken ? " fill--grey" : ligthen ? " fill--primary400" : " fill--primary100"
              }`}
              style={{
        ...
        {circle ? (
          ...
          >
            <CircleDoubleSVG
              className={`${
                darken ? " stroke--grey" : ligthen ? "stroke--primary400" : "stroke--primary100"
              }`}
              style={{
