...
const Header: React.FunctionComponent<HeaderProps> = ({
  ...
  useEffect(() => {
    ...
    location.pathname,
    menuIsLigth,
    refHeaderContainer.current?.clientHeight,
    theme,
  ]);
  ...
  return (
    <header
      ...
      className={`header${theme === Theme.dark ? " header--dark" : " header--ligth"}${
        menuIsOpen || menuHide ? " header--eventnone" : ""
      }`}
      data-testid="header"
    >
      ...
      <NavBarButton routeList={RouteList} ligth={navButtonLigth} onClick={onClick} />
    </header>
  );
};
